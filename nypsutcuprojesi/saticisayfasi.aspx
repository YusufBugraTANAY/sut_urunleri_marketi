<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="saticisayfasi.aspx.cs" Inherits="nypsutcuprojesi.saticisayfasi" %>
...
<span class="form-label">Satıcı ID</span>
	<asp:TextBox ID="urunaditxt" CssClass="form-control" runat="server" placeholder="Ürün ismi" required></asp:TextBox>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<span class="form-label">Ürün Adedi</span>
	<asp:TextBox ID="urunadettxt" CssClass="form-control" TextMode="number" runat="server" placeholder="Ürün adedi" required></asp:TextBox>
</div>
</div>
</div>
	<div class="row form-group">
	<asp:Button ID="uruneklebtn" OnClick="uruneklebtn_Click" CssClass="submit-btn" runat="server" Text="Urun Ekle" />
		</div>
</form>
</div>
</div>
